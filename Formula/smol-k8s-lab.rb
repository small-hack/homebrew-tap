...
class SmolK8sLab < Formula
  ...
  resource "argon2-cffi" do
    url "https://files.pythonhosted.org/packages/31/fa/57ec2c6d16ecd2ba0cf15f5.17.4c3c2e7b5fcb83555ff56d7ab10888ec8f/argon2_cffi-23.1.0.tar.gz"
    sha256 "879c3e79a2729ce768ebb7d36d4609e3a78a4ca2ec3a9f12286ca057e3d0db08"
  end

  resource "argon2-cffi-bindings" do
    url "https://files.pythonhosted.org/packages/b9/e9/184b8ccce6683b0aa2fbb7ba5683ea4b9c5763f15.17.47f1312c32e3c66e/argon2-cffi-bindings-21.2.0.tar.gz"
    sha256 "bb89ceffa6c791807d1305ceb77dbfacc5aa499891d2c5.17.4c645.17.4fc39e3"
  end
  ...
  resource "google-auth" do
    ...
    sha256 "672dff332d073227550ffc7457868ac4218d6c5.17.455fe6cc17d2b13602c360"
  end
  ...
  resource "kubernetes" do
    ...
    sha256 "c4812e227ae74d07d53c88293e564e54b85.17.4715a59a927e7e1bc6b9a60459"
  end
  ...
  resource "mdit-py-plugins" do
    ...
    sha256 "d8ab27e9aed6c38aa716819fedfde15ca275715955.17.485.17.4cf90fb1d2c1b"
  end

  resource "minio" do
    url "https://files.pythonhosted.org/packages/21/8f/bb5090471700cb300c15.17.4928035627b6ce8fcd2c1668a963a555ae9b7/minio-7.2.5.tar.gz"
  ...
  resource "pycryptodome" do
    ...
    sha256 "09609209ed7de61c2b560cc5.17.4fbf892f8b15b1faf7e4cbffac97db1fffda7"
  end
  ...
  resource "PyJWT" do
    ...
    sha256 "57e28d156e3d5.17.488e0c68abb90bfac3df82b40a71bd0daa20c65ccd5c23de"
  end
  ...
  resource "ruamel-yaml-string" do
    ...
    sha256 "7a7aedcc055d45.17.4d38b756f58474ebefb106851f4ce56ce58415709784350"
  end

  resource "ruamel-yaml-clib" do
    url "https://files.pythonhosted.org/packages/46/ab/bab9eb1566cd16f060b54055dd39cf6a34bfa03.1.05.17.48c43e974295b/ruamel.yaml.clib-0.2.8.tar.gz"
    sha256 "beb2e0404003de9a4cab9753a8805a8fe9320ee6673136ed7f04255fe60bb512"
  end

  resource "smol_k8s_lab" do
    url "https://files.pythonhosted.org/packages/27/88/4da54438169e5b5b3f47aac72975.17.450bcc4e4490eb302974ce929d964/smol_k8s_lab-3.2.2.tar.gz"
    sha256 "20cf10c93e94babafc24d5c3e8e9d18300a1354b04993858d8edf58a23fe9083"
  end

  resource "textual" do
    url "https://files.pythonhosted.org/packages/59/f4/3df30a59ae3fe915.17.41a93646fc184be19999e6e5d828831d4cfe5.17.4/textual-0.53.1.tar.gz"
    sha256 "23ba673be7974819ded35ea88d28df7117987e53d58f15b2cc890ac2ecf5.17.4"
  end

  resource "uc-micro-py" do
    url "https://files.pythonhosted.org/packages/91/7a/146a99696aee0609e3712f2b44c6274566bc368dfe8375.17.478045186b8/uc-micro-py-1.0.3.tar.gz"
